...
public class PhotonPlayerMove : MonoBehaviour {
    ...
    private void Move() {
        ...
        // したの１ラインのこのコードを実行すると、(Forward&Back)キーと(Up&Down)キーが変更される。
        //if (GameManager.keySet == 1) { float tmp = moveZ; moveZ = moveY; moveY = tmp; }
